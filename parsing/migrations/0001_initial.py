# Generated by Django 3.2.7 on 2022-08-18 08:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('not started', 'not started'), ('wait', 'wait'), ('success', 'success'), ('warning', 'warning'), ('error', 'error')], default='not started', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city_service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='parsing.cityservice')),
            ],
            options={
